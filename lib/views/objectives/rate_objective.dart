...
class RateObjective extends StatefulWidget {
  const RateObjective({super.key});

  @override
  State<RateObjective> createState() => _RateObjectiveState();
}

class _RateObjectiveState extends State<RateObjective> {
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                      ...
                      child: Column(
                        children: [
                          RatingBar.builder(
                            ...
                            unratedColor: const Color(0xffA0A7BA),
                            itemCount: 5,
                            itemPadding:
                  ...
                  Text("Would you recommend this objective to others?",
                      style: Theme.of(context).textTheme.titleLarge!.copyWith(
                            fontSize: 15,
                            fontWeight: FontWeight.w600,
                          )),
